            ...
            <>
                <section id={'contact'} className={'relative w-full h-fit pt-20 sm:pt-[35vh] mb-5'}>
                    ...
                    <div
                        ...
                        className={'cursor-hover-item w-fit hidden xl:flex text-5xl sm:text-5xl lg:text-8xl lg:flex-col relative font-bold font-panchang uppercase my-24  sm:break-words lg:break-normal underline'}>
