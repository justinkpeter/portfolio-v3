        ...
        <>
            <section id={'about'} className={'relative h-fit  my-24 pt-14 sm:my-36 md:my-12'}>
                ...
                <div className={'text-4xl md:text-5xl lg:text-7xl relative font-bold font-panchang uppercase pt-16 lg:pt-28 sm:pl-[10rem] lg:pl-[16rem] h-fit'}>
                    ...
                    <div className={'relative w-full lg:w-3/4 h-fit text-xl flex flex-col sm:space-y-6 xl:flex-row py-0 space-y-6 sm:py-6 xl:py-0 lg:space-y-6 xl:space-y-0 normal-case font-cabinet font-medium mt-8 sm:mt-10 '}>
                        <div className={'w-full font-bold xl:w-1/2 uppercase text-xl md:text-2xl lg:text-3xl  '}>
                            <h5>The Holy Trinity to my life</h5>
                        </div>
                        <div className={' w-full sm:w-3/4 md:w-full xl:w-1/2 flex flex-col text-lg sm:text-xl md:text-2xl relative'}>
                            <p className={'w-full'}>
